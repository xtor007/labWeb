...
ev.use('/Kepler.jpeg', express.static(__dirname + '/../public/Kepler.jpeg'))
ev.use('/Newton.jpeg', express.static(__dirname + '/../public/Newton.jpeg'))
ev.use('/Einshtein.jpeg', express.static(__dirname + '/../public/Einshtein.jpeg'))
ev.use('/Korolev.jpeg', express.static(__dirname + '/../public/Korolev.jpeg'))
